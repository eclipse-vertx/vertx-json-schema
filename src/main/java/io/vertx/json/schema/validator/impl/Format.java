...
public class Format {
  ...
  private static boolean testRelativeJsonPointer(String value) {
    return RELATIVE_JSON_POINTER.matcher(value).matches();
  }
  ...
  private static boolean testRegex(String value) {
    if (Z_ANCHOR.matcher(value).matches()) {
      return false;
    }
    try {
  ...
  private static boolean testEmail(String value) {
     ...
     if (
       !EMAIL_HOST.matcher(parts[1]).matches() ||
       !EMAIL_NAME.matcher(parts[0]).matches()
     ) {
       return false;
     }
     for (String part : parts[1].split("\\.")) {
       if (!EMAIL_HOST_PART.matcher(part).matches()) {
         return false;
       }
     }
    return true;
  ...
  private static boolean testUrl(String value) {
    return URL_.matcher(value).matches();
  }
  ...
  private static boolean testUriTemplate(String value) {
    return URITEMPLATE.matcher(value).matches();
  }
  ...
  private static boolean testUriReference(String value) {
    return URIREF.matcher(value).matches();
  }
  ...
  private static boolean testUri(String value) {
    ...
    return NOT_URI_FRAGMENT.matcher(value).matches() && URI_PATTERN.matcher(value).matches();
  }
  ...
  private static boolean testDuration(String value) {
    return value.length() > 1 &&
      value.length() < 80 &&
      (DURATION_A.matcher(value).matches() ||
        (DURATIION_B.matcher(value).matches() &&
          DURATIION_C.matcher(value).matches()));
  }
  ...
  private static boolean testDateTime(String value) {
    return FASTDATETIME.matcher(value).matches();
  }
  ...
  private static boolean testTime(String value) {
    return FASTTIME.matcher(value).matches();
  }
  ...
  private static boolean testDate(String value) {
    return FASTDATE.matcher(value).matches();
  }
}
